...
public:
    ...
    void Set_wait_time_add(float t);
    void Set_wait_time_mul(float t);
    void Set_on_timeout(Callback f);

    const float& Get_pass_time() const;
    const bool&  Get_is_shotted() const;
